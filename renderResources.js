...
var img = new Image();
img.src = 'sprites/SpriteSheet32x32.png';
var player = {
    sprite: img,
    sx: 0,
    sy: 32,
...
function initStaticObstacles() { //if statements to initialize same code for different rows to create full layout
        ...
        for (var i = 0; i < staticSpawn.length; i++) {
            new gameObject(staticObjects, "staticObjects", "sprites/obstacle.png", 0, 0, 500, 385, staticSpawn[i][0], staticSpawn[i][1], null, 64, 32);
        }
        var wallPos = [
        ...
        new gameObject(staticObjects, "staticObject", 'sprites/SpriteSheet32x32.png', 224, 0, 32, 32, 608, 64, null, 32, 32);
}
